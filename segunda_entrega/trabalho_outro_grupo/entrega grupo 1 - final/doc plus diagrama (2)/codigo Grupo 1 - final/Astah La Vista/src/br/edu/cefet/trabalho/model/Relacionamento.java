...
import br.edu.cefet.trabalho.controller.Component;

public abstract class Relacionamento extends Component implements Serializable{
	...
	public void addElementos(Elemento elemento1, Elemento elemento2){
		this.elemento.add(elemento1);
		this.elemento.add(elemento2);	
	}

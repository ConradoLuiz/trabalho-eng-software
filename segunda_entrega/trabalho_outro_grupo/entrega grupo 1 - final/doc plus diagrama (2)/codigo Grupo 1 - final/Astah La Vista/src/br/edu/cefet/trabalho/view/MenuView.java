...
import br.edu.cefet.trabalho.controller.CarregarDiagramaCommand;
import br.edu.cefet.trabalho.controller.DiagramCreationController;
import br.edu.cefet.trabalho.controller.SalvarDiagramaCommand;
import br.edu.cefet.trabalho.controller.UndoCommand;
...
public class MenuView extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent eve) {
		...
		if(eve.getSource() == b3) {
			CarregarDiagramaCommand cdc = new CarregarDiagramaCommand();
			cdc.execute();
	...
	public void salvarDiagrama() {
		SalvarDiagramaCommand sdc = new SalvarDiagramaCommand();
		sdc.execute();
